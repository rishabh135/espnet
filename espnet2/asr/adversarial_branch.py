...
class SpeakerAdv(torch.nn.Module):
	...
	def __init__(self, odim, eprojs, advunits, advlayers, device="cuda", margin=3, dropout_mid=0.0, dropout_inp=0.0, dropout_out=0.0):
		...
		# self.lsoftmax_linear = LSoftmaxLinear(input_features=advunits, output_features=odim, margin=margin, device=self.device)
