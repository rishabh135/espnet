...
class Transformer(AbsTTS):
    ...
    def forward(
        ...
        Args:
            ...
            feats (Tensor): Batch of padded target features (B, Lmax, odim).  /bayesian latent
    ...
    def inference(
        ...
        Args:
            ...
            feats (Optional[Tensor]): Feature sequence to extract style embedding   bayesian latent
                (T_feats', idim).
