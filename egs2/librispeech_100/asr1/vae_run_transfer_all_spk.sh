...
project_name="vae_xtransfer_june_14_all_spk_all_phases"
...
asr_config=/home/rgupta/dev/espnet/egs2/librispeech_100/asr1/conf/train_transfer_all_spk.yaml
