...
if "${use_xvector}"; then
    ...
    # Update json
    # for name in ${train_set} ${dev_set} ${eval_set}; do
    #     ${global_dir}/local/update_json.sh ${dumpdir}/${name}/data.json ${nnet_dir}/xvectors_${name}/xvector.scp
    # done
    ...
    #         _suf=""
    #         ${global_dir}/utils/copy_data_dir.sh "${data_feats}${_suf}/${dset}" "${dumpdir}/mfcc/${dset}"
