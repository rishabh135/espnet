...
project_name="v10_multi_adv_simple_check"


experiment_name="multiadv_40_each_adv_weight_10" # name of the experiment, just change it to create differnet folders
