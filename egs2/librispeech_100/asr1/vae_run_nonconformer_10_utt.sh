...
project_name="vae_non_conformer_april_20"
...
asr_config=/home/rgupta/dev/espnet/egs2/librispeech_100/asr1/conf/train_vae_nonconformer.yaml
...
###################################################################################################################################################################################################
###################################################################################################################################################################################################
./vae_asr_nonconformer_10_utt.sh \
    --skip_data_prep true \
    --skip_train false \
    --skip_eval true \
    --lang en \
